...
import { mediaQueries } from "../../../src/utils/themes/mediaQueries";
...
const Typography = styled.div<TextProps>`
  ...
  font-family: ${({ font }) => typography[font]?.fontFamily || "Inter"};
  ...
  ${mediaQueries.smallerphone} {
    font-size: ${({ font }) => typography[font]?.smallerPhoneSize};
    line-height: ${({ font }) => typography[font]?.smallerPhoneLineHeight};
  }
`;
